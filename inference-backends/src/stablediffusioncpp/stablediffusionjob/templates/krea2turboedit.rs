use crate::stablediffusioncpp::{
    StableDiffusionJob,
    stablediffusionjob::{FlashAttentionMode, RefImageArgs, TextEncoder},
};
...
impl StableDiffusionJob {
    pub fn krea2_turbo_edit_job() -> Self {
        let job = Self {
            ...
            sampling_method: crate::stablediffusioncpp::SamplingMethod::Euler,
            scheduler: crate::stablediffusioncpp::Scheduler::Simple,
